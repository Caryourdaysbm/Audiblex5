...
import MaleMeasurement from "../../components/MaleMeasurement";
import FemaleMeasurement from "../../components/FemaleMeasurement";
...
const Measurement = () => {
  ...
  return (
    <MeasurementPage className="">
      ...
      {isMale ? <FemaleMeasurement /> : <MaleMeasurement />}
    </MeasurementPage>
  );
};
